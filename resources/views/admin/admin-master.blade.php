...
<html lang="en">
  ...
  <body>
    ...
    @else
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Medilab</a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="{{route('admin-appoint')}}"  class="sl-menu-link @yield('brand')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('admin-doctor')}}" class="nav-link @yield('add-doctors')">Add Doctors</a></li>
          <li class="nav-item"><a href="{{route('manage-doctor')}}" class="nav-link @yield('manage-doctors')">Manage Doctor</a></li>
        </ul>
